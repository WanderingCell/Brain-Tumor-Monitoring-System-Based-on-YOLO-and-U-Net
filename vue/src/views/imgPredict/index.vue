<template>
  ...
  <div v-if="state.predictionResult.suggestion" class="ai-suggestion-box markdown-body">
    <div v-html="state.predictionResult.suggestion"></div>
  </div>
</div>
...
.ai-suggestion-box {
  ...
  margin: 0 auto;
  padding: 30px 40px;
  background: linear-gradient(145deg, #e0f7fa, #e6f7ff); // 渐变蓝绿，柔和
  border: 1px solid #91d5ff;
  border-radius: 16px;
  box-shadow: 0 12px 24px rgba(0, 128, 255, 0.15); // 蓝色阴影，科技感
  color: #003a8c;
  ...
  &:hover {
    box-shadow: 0 16px 32px rgba(0, 128, 255, 0.2);
  }
